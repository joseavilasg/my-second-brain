...
[Source](https://spblog.net/post/2020/06/10/how-to-effectively-delete-node-modules-on-windows)
...
<Image
  src="https://spblog.net/image.axd?picture=/2020/delete-node-modules/command.png"
  alt="Image 1"
  width={600}
  height={365}
/>
<Image
  src="https://spblog.net/image.axd?picture=/2020/delete-node-modules/result.png"
  alt="Image 2"
  width={600}
  height={365}
/>
